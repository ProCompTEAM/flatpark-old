...
use flatpark\models\player\BossBarSession;
use flatpark\Tasks;
...
{
    private const DEFAULT_TITLE = "FlatPark";
    ...
    public function initializePlayerSession(FlatParkPlayer $player) : bool
    {
    ...
    public function setBossBar(FlatParkPlayer $player, ?string $title = null, ?int $percents = null)
    {
    ...
    public function setTitle(FlatParkPlayer $player, int $fakeEntityId, string $title)
    {
    ...
    public function setPercentage(FlatParkPlayer $player, int $fakeEntityId, int $percents)
    {
    ...
    public function hideBossBar(FlatParkPlayer $player)
    {
    ...
    private function initializeHealthAttribute(FlatParkPlayer $player, int $fakeEntityId)
    {
    ...
    private function createBossEntity(FlatParkPlayer $player, int $fakeEntityId) : int
    {
