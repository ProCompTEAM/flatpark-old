<?php
namespace flatpark\components\vehicles\models\base;
...
abstract class BaseCar extends BaseVehicle
{
    ...
    protected ?FlatParkPlayer $driver;
    protected ?FlatParkPlayer $passenger;
    protected ?FlatParkPlayer $rentedBy;
    ...
    public function getDriver() : ?FlatParkPlayer
    {
        return $this->driver;
    }

    public function getPassenger() : ?FlatParkPlayer
    {
    ...
    public function performAction(FlatParkPlayer $player, ?int $data = null)
    {
        if (is_null($data)) {
            return;
        }
    ...
    public function buyVehicle(FlatParkPlayer $player, ?bool $choice = null)
    {
        if (!isset($choice)) {
            return;
        }
    ...
    public function attack(EntityDamageEvent $event) : void
    {
        ...
        if ($event instanceof EntityDamageByEntityEvent) {
            if ($event->getDamager() instanceof FlatParkPlayer) {
    ...
    public function setDriver(FlatParkPlayer $player, bool $force = false) : bool
    {
    ...
    public function setPassenger(FlatParkPlayer $player, bool $force = false) : bool
    {
        if ($force) {
    ...
    public function tryToRemovePlayer(FlatParkPlayer $player) : bool
    {
    ...
    public function setRentedBy(FlatParkPlayer $player)
    {
    ...
    protected function trySetPlayerDriver(FlatParkPlayer $player)
    {
    ...
    protected function trySetPlayerPassenger(FlatParkPlayer $player)
    {
    ...
    protected function broadcastLink(FlatParkPlayer $player, int $type = EntityLink::TYPE_RIDER)
    {
    ...
    private function performRentCheck(FlatParkPlayer $player) : bool
    {
    ...
    private function setRented(FlatParkPlayer $player)
    {
    ...
    private function updateUserFlags(FlatParkPlayer $player, bool $status, bool $driver = true)
    {
    ...
    private function handleInteract(FlatParkPlayer $player)
    {
    ...
    private function showRentForm(FlatParkPlayer $player)
    {
