...
class Tracking extends Component
{
    ...
    public function isTracked(FlatParkPlayer $player) : bool
    {
        return isset($this->tracked[$player->getName()]) and $this->tracked[$player->getName()];
    }

    public function enableTrack(FlatParkPlayer $player, FlatParkPlayer $causer = null)
    {
    ...
    public function disableTrack(FlatParkPlayer $player, FlatParkPlayer $causer = null)
    {
        $playerName = $player->getName();
    ...
    public function message(FlatParkPlayer $player, string $message, $rad=7, string $prefix = "[UNDEFINED]")
    {
    ...
    public function actionRP(FlatParkPlayer $player, string $action, int $distance = 7, string $prefix = "[UndefinedRP]")
    {
    ...
    private function broadcastAdmins(array $messages = [], FlatParkPlayer $sender = null, int $distance = 7)
    {
    ...
    private function sendMessage(FlatParkPlayer $player, array $messages = [])
    {
    ...
    private function saveMessage(FlatParkPlayer $player, string $prefix, string $message)
    {
