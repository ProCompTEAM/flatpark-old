...
class Workers extends Component
{
    ...
    public function takeBox(FlatParkPlayer $player)
    {
    ...
    private function handleBoxTake(FlatParkPlayer $player)
    {
    ...
    public function putBox(FlatParkPlayer $player)
    {
    ...
    private function handlePutBox(FlatParkPlayer $player)
    {
    ...
    private function isNearAreaWithBoxes(FlatParkPlayer $player) : bool
    {
        return $this->isPlayerNearPoint($player->getPosition(), MapConstants::POINT_GROUP_WORK1);
    }

    private function isNearUnloadingPoint(FlatParkPlayer $player) : bool
    {
