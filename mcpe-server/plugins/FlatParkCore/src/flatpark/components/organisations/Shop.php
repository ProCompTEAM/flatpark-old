...
class Shop extends Component
{
    ...
    public function initialize()
    {
        ...
        // TODO: Move to datacenter(watch task #516)
    ...
    private function handleCreateSign(SignChangeEvent $event, array $lines, FlatParkPlayer $player)
    {
    ...
    private function createSign(SignChangeEvent $event, string $name, int $price, int $id, FlatParkPlayer $player)
    {
