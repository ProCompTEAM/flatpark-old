...
class BanCommand extends Command
{
    ...
    private function sendBanForm(FlatParkPlayer $player)
    {
    ...
    public function answerBanForm(FlatParkPlayer $player, ?array $inputData = null)
    {
    ...
    private function checkInputData(FlatParkPlayer $player, string $userName, string $reason, int $months, int $days, int $hours) : bool
    {
    ...
    private function processBan(FlatParkPlayer $issuer, string $targetName, string $reason, int $months, int $days, int $hours)
    {
    ...
    private function banOnlinePlayer(FlatParkPlayer $issuer, FlatParkPlayer $target, string $reason, int $months, int $days, int $hours)
    {
    ...
    private function banOfflinePlayer(FlatParkPlayer $issuer, string $targetName, string $reason, int $months, int $days, int $hours)
    {
