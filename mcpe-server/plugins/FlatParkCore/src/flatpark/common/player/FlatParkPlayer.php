<?php
namespace flatpark\common\player;
...
class FlatParkPlayer extends Player
{	
    ...
    public static function cast(Player $player) : ?FlatParkPlayer {
        if($player === null) {
            return null;
        } elseif($player instanceof FlatParkPlayer) {
            return $player;
        } else {
            throw new Exception("Player isn't FlatParkPlayer");
        }
    }
